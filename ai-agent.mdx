...
Drop this prompt into Cursor, Claude Code, or any coding agent to scaffold a complete Blink integration end-to-end. The prompt includes discovery questions, signer endpoint setup, SDK wiring, and verification steps.
...
<Prompt description="Integrate Blink end-to-end" icon="magic-wand-sparkles" actions={["copy"]}>
---
