...
description: Complete type reference for the Transfer SDK.
---
...
Configuration for a `Transfer` instance. See [Transfer Class](/sdk-reference/checkout-class) for detailed descriptions.
