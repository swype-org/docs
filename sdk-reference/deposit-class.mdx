...
| `webviewBaseUrl` | `string` | `'https://pay.blink.cash'` | Base URL of the hosted payment webview app. The SDK appends `merchantId`, `payload`, and `signature` as query parameters. |
