---
title: Quickstart
description: Get a working Blink transfer integration in 5 minutes.
---
...
You now have a working transfer flow. To go to production:
...
<Steps>
  ...
  <Step title="Handle errors gracefully">
    [Error Handling](/sdk-reference/errors) — use `TransferError` codes and `getDisplayMessage()` in your UI.
  </Step>
