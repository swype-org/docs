---
title: Quickstart
description: Get a working Blink checkout integration in 5 minutes.
---
...
<Steps>
  ...
  <Step title="Handle errors gracefully">
    [Error Handling](/sdk-reference/errors) — use `CheckoutError` codes and `getDisplayMessage()` in your UI.
  </Step>
