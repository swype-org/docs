...
<Info>
  Testnet deposits run through the [testnet sandbox](/integration/testnet-sandbox), a separate environment with its own API and merchant registry. The sandbox currently supports Base Sepolia and Sepolia.
</Info>
...
<div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
  <img src="/images/blink-link-wallet-1.png" alt="Link wallet picker" style={{ width: '50%', borderRadius: '12px' }} />

  <img src="/images/blink-link-wallet-2.png" alt="Search across more wallets" style={{ width: '50%', borderRadius: '12px' }} />
</div>
...
| Monad | `143` | `USDC` |
| HyperEVM | `999` | `USDC`, `USDH` |
| Solana | `792703809` | `USDC`, `USDT`, `CASH` |
