...
description: Install and configure the Mobile Deposit SDK to trigger deposit flows from React Native and native mobile apps.
---
...
const deposit = new MobileDeposit({
  ...
  // Base URL of the hosted payment app. Default: 'https://pay-staging.blink.cash'
  webviewBaseUrl: 'https://pay-staging.blink.cash',
