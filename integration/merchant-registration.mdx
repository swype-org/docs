...
<CardGroup cols={2}>
  <Card title="Email us" icon="envelope" href="mailto:contact@blink.cash">
    Send your public key and merchant details to **contact@blink.cash**
  </Card>
...
<Steps>
  ...
  <Step title="Send the new public key to Blink">
    Email your updated PEM to [contact@blink.cash](mailto:contact@blink.cash) or [book a meeting](https://calendar.app.google/3fqK5VntM89fFXnJ9) with the Blink team.
  </Step>
