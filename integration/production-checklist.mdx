...
- [ ] Error handling implemented with `TransferError` codes and user-friendly messages via `getDisplayMessage()`.
- [ ] `transfer.destroy()` called on component unmount / page unload.
