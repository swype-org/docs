...
<div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
  <img src="/images/blink-deposit-amount.png" alt="Pick a deposit amount" style={{ flex: '1 1 0', minWidth: 0, borderRadius: '12px' }} />

  <span style={{ flex: '0 0 auto', fontSize: '24px', color: '#9ca3af' }}>→</span>

  <img src="/images/blink-deposit-passkey.png" alt="Confirm with a passkey" style={{ flex: '1 1 0', minWidth: 0, borderRadius: '12px' }} />

  <span style={{ flex: '0 0 auto', fontSize: '24px', color: '#9ca3af' }}>→</span>

  <img src="/images/blink-deposit-complete.png" alt="Deposit complete" style={{ flex: '1 1 0', minWidth: 0, borderRadius: '12px' }} />
</div>
...
Drop this prompt into Cursor, Claude Code, or any other coding agent to complete an end-to-end Blink integration.
...
Your mission is to integrate Blink end-to-end into this project: a server-side signer endpoint, the appropriate client SDK, and a working deposit button. The full source of truth lives at `https://docs.blink.cash` — fetch the linked pages as you go and treat them as authoritative over anything you have memorised.
