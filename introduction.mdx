...
Both **web** and **mobile** SDKs are available. The web SDK (`@swype-org/deposit`) renders the payment flow in a modal iframe overlay. The mobile SDK (`@swype-org/deposit-mobile`) opens the same hosted flow in an in-app browser and returns the result via a deep link callback.
